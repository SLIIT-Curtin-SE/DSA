...
class DSAGraph
{
    ...
    public void addVertex(String inLabel, Object inValue, String inVCode)
    {
        if (hasVertex(inLabel) == false)
        {
            DSAGraphVertex vertex = new DSAGraphVertex(inLabel, inValue, inVCode);
            vertices.insertLast(vertex);
        }
    }

    private void addEdge(String inFrom, String inTo, Object inValue, String inECode)
    {
        if (hasEdge(inFrom, inTo) == false)
        {
            DSAGraphEdge edge = new DSAGraphEdge(inFrom, inTo, inValue, inECode);
    ...
    public void addEdges(String inLabel1, String inLabel2, Object inValue, String inECode)
    {
        if (getVertex(inLabel1) != null && getVertex(inLabel2) != null)
        {
            addEdge(inLabel1, inLabel2, inValue, inECode);
